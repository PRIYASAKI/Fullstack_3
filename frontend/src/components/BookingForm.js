...
const BookingForm = () => {
  ...
  useEffect(() => {
    const fetchBookedDates = async () => {
      try {
        const response = await axios.get(`${API_URL}/api/bookings/${roomId}`)
  ...
  const handlePayNow = async (paymentId = null) => {
    ...
    try {
      ...
      const response = await axios.post(`${API_URL}/api/book`, bookingData, {
            ...
            <div className="upi-content">
              <div className="qr-container">
                <div className="qr-code">
                  ...
                  <QRCodeSVG
                    value={`upi://priya123@canara&pn=Royal%20Castle%20Farm%20Stay&am=${totalAmount}&cu=INR`}
                    size={250}
                    bgColor={"#ffffff"}
                    fgColor={"#000000"}
                    level={"L"}
                ...
                <div className="upi-details">
                  <p>
                    <strong>UPI ID:</strong> Priya@canara
                  </p>
                  <p>
